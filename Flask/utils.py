...
pest_dic = {
    ...
    'fruit_fly': """ <br/>Pest: Fruit Fly<br/>
        <br/> <b>Danger</b>:
        <br/><br/> 1. Fruit flies lay eggs inside ripening fruits, and their larvae feed on the fruit flesh, causing decay and making them unmarketable.
        <br/> 2. They also spread fungal and bacterial diseases that further damage crops.
        <br/><br/> <b>How to Get Rid of Them?</b> <br/>
        <br/>1. <b>Traps</b>: Use apple cider vinegar or fermented fruit in a container with small holes to attract and trap them.
        <br/>2. <b>Sanitation</b>: Remove overripe and fallen fruits from the ground to eliminate breeding sites.
        <br/>3. <b>Exclusion</b>: Use fine mesh netting over fruiting plants to prevent flies from laying eggs.
        <br/>4. <b>Chemical Control</b>: If necessary, use organic-approved insecticides like Spinosad or pyrethrin-based sprays.""",

        'scale_insect': """ <br/>Pest: Scale Insect<br/>
        <br/> <b>Danger</b>:
        <br/><br/> 1. Scale insects feed on plant sap, causing wilting, yellowing, and reduced plant vigor.
        <br/> 2. They produce honeydew, which leads to fungal infections like sooty mold.
        <br/> 3. Heavy infestations can lead to branch dieback and plant death.
        <br/><br/> <b>How to Get Rid of Them?</b> <br/>
        <br/>1. <b>Manual Removal</b>: Scrape off adult scale insects with a soft brush or cloth.
        <br/>2. <b>Horticultural Oil</b>: Spray dormant oil in winter to kill overwintering eggs.
        <br/>3. <b>Pruning</b>: Remove and destroy heavily infested plant parts.
        <br/>4. <b>Chemical Control</b>: Use insecticidal soaps or pyrethrin-based insecticides if infestation persists.""",

        'aphid': """ <br/>Pest: Aphid<br/>
        <br/> <b>Danger</b>:
        <br/><br/> 1. Aphids suck sap from plant stems and leaves, weakening plants and stunting growth.
        <br/> 2. They excrete honeydew, which promotes the growth of sooty mold that blocks sunlight and reduces photosynthesis.
        <br/> 3. Aphids can transmit viral plant diseases.
        <br/><br/> <b>How to Get Rid of Them?</b> <br/>
        <br/>1. <b>Neem Oil</b>: Spray neem oil, which disrupts aphids' reproductive cycles and acts as an anti-feedant.
